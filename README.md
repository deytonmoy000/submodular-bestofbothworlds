...
**!NOTE!** You will need to download the data (matrix) files **"images_10K_mat.csv"** (https://adminmyfsu-my.sharepoint.com/:x:/g/personal/td18d_my_fsu_edu/EevKBMPIU-dCo30rMrxxt_oBWKi9r74ROgjMEwqyzbgS3A?e=QkfUR0) and **"tweets_keyword_mat.csv"** (https://adminmyfsu-my.sharepoint.com/:t:/g/personal/td18d_my_fsu_edu/Ebsak2kz8m5IoGPJkoGLYeYBvkkE8Uqf11aYECSl0aEpmw?e=xjeJmR) and place it in the *"submodular/data"*  directory. 
